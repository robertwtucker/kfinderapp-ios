...
public struct FoodSearchCriteria: Codable, Sendable {
  ...
  // Search terms to use in the search. The string may also include standard search operators.
  // see: https://fdc.nal.usda.gov/help.html#bkmk-2
  ...
  // Optional. Specify one of the possible values to sort by that field. Note, dataType.keyword will be dataType and
  // description.keyword will be description in future releases.
