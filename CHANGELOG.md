...
Revisiting project after a long hiatus. Rewriting using SwiftUI.
...
- Settings Tab with acknowledgements page and application version display (the account section is currently non-functional)
- Switch toggles the display of the serving weight between metric and imperial units (Settings Tab)
...
[Unreleased]: https://github.com/robertwtucker/kfinder-ios/compare/master...v0.3.0
